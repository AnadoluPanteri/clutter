...
/* VOID:BOXED (./clutter-marshal.list:3) */

/* VOID:INT (./clutter-marshal.list:4) */

/* VOID:INT64,INT64,FLOAT,BOOLEAN (./clutter-marshal.list:5) */
void
...
/* VOID:INT,INT,INT,INT (./clutter-marshal.list:7) */
void
...
/* VOID:OBJECT (./clutter-marshal.list:8) */

/* VOID:OBJECT,OBJECT,PARAM (./clutter-marshal.list:9) */
void
...
/* VOID:OBJECT,POINTER (./clutter-marshal.list:10) */
void
...
/* VOID:STRING,BOOLEAN,BOOLEAN (./clutter-marshal.list:11) */
void
